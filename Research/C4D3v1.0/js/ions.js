...
class LiveProperty {
    ...
    setVariable(variable) {
        ...
        if (printClass.printStatus)
            console.log(variable.getPrototype().value);
        if (printClass.printStatus)
            console.log(Object.getPrototypeOf(variable.getPrototype().value));
    ...
    setValue(value) {
        //console.log(value);
        if (printClass.printStatus)
            console.log("setValue of LiveProperty");
...
class ControlProxy {
    ...
    getLiveProperty(tag) {
        if (printClass.printStatus)
            console.log(ControlProxy.map.get(tag));
        if (printClass.printStatus)
            console.log("getLiveProperty method of ControlProxy");
        if (printClass.printStatus)
            console.log(this.map.get(tag));
...
class ControlSlider {
    ...
    constructor(name, xPos, yPos) {
        ...
        this.slider = new SliderClass(name, xPos, yPos);
        if (printClass.printStatus)
            console.log(name);
...
function transformer$1() {
  ...
  function scale(x) {
    return isNaN(x = +x) ? unknown : (output || (output = piecewise$$1(domain.map(transform), range, interpolate)))(transform(clamp(x)));
  }
...
var line = function() {
  ...
  line.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : constant$11(+_), line) : x;
  };

  line.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : constant$11(+_), line) : y;
  };
...
function link$2(curve) {
  ...
  link.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : constant$11(+_), link) : x;
  };

  link.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : constant$11(+_), link) : y;
  };
...
var voronoi = function() {
  ...
  voronoi.x = function(_) {
    return arguments.length ? (x = typeof _ === "function" ? _ : constant$12(+_), voronoi) : x;
  };

  voronoi.y = function(_) {
    return arguments.length ? (y = typeof _ === "function" ? _ : constant$12(+_), voronoi) : y;
  };
...
var zoom = function() {
  ...
  zoom.transform = function(collection, transform$$1, point$$1) {
    var selection$$1 = collection.selection ? collection.selection() : collection;
    selection$$1.property("__zoom", defaultTransform);
    if (collection !== selection$$1) {
      schedule(collection, transform$$1, point$$1);
    } else {
  ...
  function schedule(transition$$1, transform$$1, point$$1) {
    transition$$1
...
class ScatterplotClass {
    ...
    setSelection(value) {
        ...
        if (this.LocalData == undefined) { }
            ...
            select(`#${this.scatterplotControlName}`).select("svg").selectAll("circle")
                .data(this.LocalData)
                .attr("stroke", function (d, index) { return value[index] == true ? "orange" : "black"; })
                .attr("stroke-width", function (d, index) { return value[index] == true ? 1 : 0.1; });
        }
    }
    setIndication(value) {
    ...
    render(parentControl) {
        ...
        const renderPlot = (data) => {
            ...
            var yScale = linear$2()
                .domain(extent(data, function (d) { return item(d, vertical); }))
                .range([plotHeight, 0]);
            //.nice();
            this.yScale = yScale;
            ...
            if (this.showVerti) {
                ...
                labelsGroup
                    ...
                    .style("font-size", 15)
                    .style("font-weight", 1000)
                    .attr("transform", `translate(${-margin.left / 2}, ${plotHeight * 0.5}) rotate(-90)`);
            }
            // create a tooltip
            var tooltip = select(div1)
                .append("div")
            ...
            if (circleSizeIndex == null) {
                var circleSize = function circleSize(d) { return 2; };
            }
            else {
                var circleSize = linear$2().domain(extent(data, (d) => item(d, circleSizeIndex))).range([5, 10]);
            }
            ...
            this.scatter
                ...
                .attr("fill", function (d) { return color$$1(item(d, colorIndex)); })
                .attr("stroke", "black")
                .attr("cx", function (d) { return xScale(item(d, horizontal)); })
                .attr("cy", function (d) { return yScale(item(d, vertical)); })
                .attr("r", 0)
                ...
                .append('title')
                .text(d => item(d, textIndex)), update => update
                .attr("fill", "black")
                .style("opacity", 1)
                .attr("stroke", "black")
                .attr("r", d => 2), exit => exit
                .attr("fill", "brown")
            ...
            svg$$1.on("mouseout", function () {
                select("rect").attr("fill-opacity", 0);
            });
            ...
            function onMouseOver(d) {
                ...
                select(this)
                    ...
                    .attr('class', 'val')
                    .style("fill", "black")
                    .attr('x', () => (event$1.pageX))
                    .attr('y', () => (event$1.pageY))
                    .style("font-size", 15)
                    .style("font-weight", 1000)
            ...
            function brushed() {
                ...
                myArrayTable = [];
                const selection = event$1.selection;
                if (selection === null) {
                    ...
                    selectAll("circle")
                        .data(data)
                        .attr("stroke", (d, index) => {
                        if (x0 <= xScale(item(d, horizontal)) &&
            ...
            var brush$$1 = brush()
                ...
                localParentControl.getProxy().getLiveProperty("brushX").setValue([xScale.invert(x0), xScale.invert(x1)]);
                localParentControl.getProxy().getLiveProperty("brushY").setValue([yScale.invert(y0), yScale.invert(y1)]);
            });
            // Add the brushing
...
class TableClass {
    ...
    makeDraggable() {
        ...
        try {
            ...
            throw Error("The Element by id " + this.tableControlName + " do not exist");
        }
    }
    //************************
    // Getters and Setters
    ...
    setHeight(value) {
        ...
        //this.updateUI();
        if (printClass.printStatus)
            console.log(this.tableControlName);
        var temp = value;
        if (printClass.printStatus)
            console.log(temp);
        if (printClass.printStatus)
    ...
    setWidth(value) {
        ...
        if (printClass.printStatus)
            console.log(this.tableControlName);
        var temp = value;
        var xcale = time().range([0, temp * 50]);
        var xAxis = axisBottom(xcale);
    ...
    setOpacity(value) {
        if (printClass.printStatus)
            console.log("setOpacity of table");
        var temp = value;
        select("rect").attr("fill-opacity", `${temp / 100}`);
    }
    ...
    updateTable_Selection(dataTable, PropData, property) {
...
class ControlTable {
    ...
    constructor(name, data, xPos, yPos, inputWidth, inputHeight) {
        ...
        this.TYPE_Opacity = new Prototype(Number.prototype, this.CTAG_Opacity, 0);
        this.TYPE_Selection = new Prototype(Array.prototype, this.CTAG_Selection, [false]);
        this.TYPE_Indication = new Prototype(Array.prototype, this.CTAG_Indication, []);
        this.TYPE_Data = new Prototype(Array.prototype, this.CTAG_Data, []);
        if (printClass.printStatus)
            console.log("I am in constructor of ControlTable");
        //Create Control Proxy
        //if(printClass.printStatus) console.log(this.TYPE_VALUE);
        this.proxy = new ControlProxy(this);
        //create live property
    ...
    setWidth(value) {
        if (printClass.printStatus)
            console.log("setWidth method of ControlTable");
    ...
    propertyChanged(e) {
        if (printClass.printStatus)
            console.log("propertyChanged method of ControlTable");
        if (printClass.printStatus)
            console.log(e);
        var tag = e.getLiveProperty().getTag();
        if (printClass.printStatus)
...
class ParallelCoordinatePlotClass {
    //margin: { top: number; right: number; bottom: number; left: number; };
    constructor(control, data, name, xPos, yPos, horizontal, vertical, inputWidth, inputHeight, helper, color$$1, dims) {
        this.width = 960;
        this.height = 480;
        if (printClass.printStatus)
            console.log("I am in constructor of ParallelCoordinatePlotClass");
    ...
    setIndication(value) {
        ...
        if (this.LocalData == undefined) {
            ...
            select(`#${this.parallelCoordinatePlotName}`).select("svg").selectAll("path")
                .data(this.LocalData)
                .attr("fill", function (d, index) {
                //console.log(d.CountryOfInterest)
                return value[index] == true ? color$$1(d.Continent) : "grey";
            });
        }
    }
    setSelection(value) {
        ...
        const renderplot = (data) => {
            ...
            for (i in dimensions) {
                ...
                if (name == "Continent") {
                    ...
                    yScale[name] = linear$2()
                        .domain(extent(data, function (d) { return d[name]; }))
                        .range([this.plotHeight, 0]);
                }
            ...
            axisGroup
                ...
                .attr("d", path$$1)
                .style("fill", "none")
                .style("stroke", function (d) { return color$$1(item(d, colorIndex));  })
                .style("opacity", 1);
            // Draw the axis:
...
class ControlParallelCoordinatePlot {
    ...
    // Constructors and Finalizer
    //**********************************************************************
    constructor(name, data, xPos, yPos, horizontal, vertical, inputWidth, inputHeight, helper, color, dims) {
        // test(evt: Event): void
        // {
        //     throw new Error("Method not implemented.");
        // }
    ...
    propertyChanged(e) {
        if (printClass.printStatus)
            console.log("propertyChanged method of controlParallelCoordinatePlot");
        if (printClass.printStatus)
            console.log(e);
        var tag = e.getLiveProperty().getTag();
        if (printClass.printStatus)
...
class ControlGradient {
    ...
    constructor(name, data, xPos, yPos, horizontal, inputWidth, inputHeight, showHoriz, showVerti, helper) {
        ...
        this.TYPE_Selection = new Prototype(Array.prototype, this.CTAG_Selection, [false]);
        if (printClass.printStatus)
            console.log("I am in constructor of ControlGradient");
        //Create Control Proxy
        //if(printClass.printStatus) console.log(this.TYPE_VALUE);
        this.proxy = new ControlProxy(this);
        //create live property
    ...
    setTranslateX(value) {
        console.log("setTranslateX method of ControlGradient");
        this.proxy.setValue(this.CTAG_xTranslate, value);
        //this.canvas.setValue(value);
    }
    getColor() {
    ...
    setColor(value) {
        if (printClass.printStatus)
            console.log("setColor method of ControlGradient");
        this.proxy.setValue(this.CTAG_Opacity, value);
        //this.canvas.setValue(value);
    }
    getTranslateY() {
    ...
    setTranslateY(value) {
        console.log("setTranslateY method of ControlGradient");
        this.proxy.setValue(this.CTAG_yTranslate, value);
        //this.canvas.setValue(value);
    }
    //**********************************************************************
...
var transform$2 = function(transform) {
  if (transform == null) return identity$10;
  var x0,
      y0,
...
class MapClass {
    ...
    render(parentControl) {
        ...
        const renderPlot = (tsvData, worldMapTopoJson, CoronaData) => {
            ...
            var svg$$1 = select(div1)
                ...
                .attr("width", this.inputWidth)
                .attr("height", this.innerHeight);
            const projection$$1 = geoMercator().scale(100)
            ...
            */
            ...
            function colorLegend(selection$$1, props) {
                const { color: color$$1, circleRadius, spacing, textOffset } = props;
                const groups = selection$$1.selectAll('g')
                    .data(color$$1.domain());
...
class ControlMap {
    ...
    setColor(value) {
        if (printClass.printStatus)
            console.log("setColor method of ControlMap");
        this.proxy.setValue(this.CTAG_Opacity, value);
        //this.canvas.setValue(value);
    }
    //**********************************************************************
    ...
    propertyChanged(e) {
        if (printClass.printStatus)
            console.log("propertyChanged method of controlMap");
        if (printClass.printStatus)
            console.log(e);
        var tag = e.getLiveProperty().getTag();
        if (printClass.printStatus)
    ...
    render(parentControl) {
        ...
        const renderPlot = (data) => {
            ...
            var dropdown = select(div1)
                ...
                .on("change", changed);
            var dropDownArrar = [{ variable: "Radius:CasesPerMillion", Index: "8" }, { variable: " Radius:DeathsPerMillion", Index: "9" }];
            dropdown
                .selectAll("option")
                .data(dropDownArrar)
                .enter().append("option")
            ...
            function colorLegend(selection$$1, props) {
                const { color: color$$1, side, spacing, textOffset } = props;
                const groups = selection$$1.selectAll('g')
                    .data(color$$1.domain());
                const groupsEnter = groups
                    .enter().append('g')
                ...
                groupsEnter
                    .merge(groups)
                    .attr('transform', (d, i) => `translate( 0,${i * spacing[i]})`);
                groups.exit().remove();
...
class ControlBubblechart {
    ...
    setColor(value) {
        if (printClass.printStatus)
            console.log("setColor method of Controlbubblechart");
        this.proxy.setValue(this.CTAG_Opacity, value);
        //this.canvas.setValue(value);
    }
    getTranslateY() {
    ...
    propertyChanged(e) {
        if (printClass.printStatus)
            console.log("propertyChanged method of controlbubblechart");
        if (printClass.printStatus)
            console.log(e);
        var tag = e.getLiveProperty().getTag();
        if (printClass.printStatus)
...
function createControl(controlName, data, name, xPos, yPos, horizontalAxes, verticalAxes, inputWidth, inputHeight, showHoriz, showVerti, helper, color$$1, size, text$$1, dims) {
    if (printClass.printStatus)
    ...
    if (controlName == "slider") {
        ...
        let parallelCoordinatePlotControl = new ControlParallelCoordinatePlot(name, data, xPos, yPos, horizontalAxes, verticalAxes, inputWidth, inputHeight, helper, color$$1, dims);
...
function createVariable(variableName, value, classtype) {
    if (printClass.printStatus)
...
Promise.all([
    ...
    function ionsExample() {
        ...
        let scatterplot01 = createControl(Scatterplot_type, ionsData, "SP-01", lPL, lPT, IonsVariables.T, IonsVariables.Z, lPW, lPH, false, true, [IonsAxes], IonsVariables.T, null, null);
        ...
        // //x = T Y = Y
        let scatterplot02 = createControl(Scatterplot_type, ionsData, "SP-02", lPL, lPT + lPH, IonsVariables.T, IonsVariables.Y, lPW, lPH, false, true, [IonsAxes], IonsVariables.T, null, null);
        ...
        // //x = T, y=X
        let scatterplot03 = createControl(Scatterplot_type, ionsData, "SP-03", lPL, lPT + 2 * lPH, IonsVariables.T, IonsVariables.X, lPW, lPH, true, true, [IonsAxes], IonsVariables.T, null, null);
        ...
        //bindVariable(scatterplot03, "Size", variable4);
        let SPH = lPH + lPH / 2;
        let SPW = lPH + lPH / 2;
        // //x = X, y= Z
        let scatterplot04 = createControl(Scatterplot_type, ionsData, "SP-04", lPL + lPW, lPT, IonsVariables.X, IonsVariables.Z, SPW, SPH - 5, true, true, [IonsAxes], IonsVariables.T, null, null);
        ...
        // //x = X, y= Z
        let scatterplot05 = createControl(Scatterplot_type, ionsData, "SP-05", lPL + lPW, lPT + SPH, IonsVariables.X, IonsVariables.Y, SPW, SPH, true, true, [IonsAxes], IonsVariables.T, null, null);
        ...
        // //x = Z, y= Y
        let scatterplot06 = createControl(Scatterplot_type, ionsData, "SP-06", lPL + lPW + SPW, lPT + SPH, IonsVariables.Z, IonsVariables.Y, SPW, SPH, true, false, [IonsAxes], IonsVariables.T, null, null);
        ...
        // //x = X, y= Z
        let insetScatterplot1 = createControl(Scatterplot_type, ionsData, "ISP-1", lPL + lPW + 3 * SPW, lPT, IonsVariables.X, IonsVariables.Z, SPW, SPH - 5, true, true, [IonsAxes], IonsVariables.T, null, null);
        ...
        let insetScatterplot2 = createControl(Scatterplot_type, ionsData, "ISP-2", lPL + lPW + 2 * SPW, lPT + SPH, IonsVariables.X, IonsVariables.Y, SPW, SPH, true, true, [IonsAxes], IonsVariables.T, null, null);
        ...
        // //x = Z, y= Y
        let insetScatterplot3 = createControl(Scatterplot_type, ionsData, "ISP-3", lPL + lPW + SPW + 2 * SPW, lPT + SPH, IonsVariables.Z, IonsVariables.Y, SPW, SPH, true, true, [IonsAxes], IonsVariables.T, null, null);
        ...
        let TW = lPW + 20;
        let TH = 3 * lPH - 50;
        let table01 = createControl(Table_type, [ionsData], "TableView-01", lPL + lPW + 4 * SPW, lPT, null, null, TW, TH, null, null, null, null, null, null);
        bindVariable(table01, "Selection", Selection_4);
        let parallelCoordinatePlot1 = createControl(ParallelCoordinatePlot_type, ionsData, "PCP-1", lPL + lPW + SPW, lPT, null, null, 2 * SPW, SPH - 7, null, null, [IonsAxes], IonsVariables.T, null, null, ["T", "X", "Y", "Z"]);
