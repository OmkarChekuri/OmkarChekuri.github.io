...
Promise.all([
    ...
    function ionsExample() {
        ...
        let parallelCoordinatePlot1 = createControl(ParallelCoordinatePlot_type, ionsData, "PCP-1", lPL + lPW + SPW, lPT, null, null, 2 * SPW, SPH - 12, null, null, [IonsAxes], IonsVariables.T, null, null, ["T", "X", "Y", "Z"]);
